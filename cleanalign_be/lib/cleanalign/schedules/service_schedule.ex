defmodule Cleanalign.Schedules.ServiceSchedule do
  ...
  policies do
    ...
    policy action_type(:update) do
      authorize_if check(&Cleanalign.RBAC.is_admin/2) or (check(&Cleanalign.RBAC.is_property_manager/2) and check(fn actor, record -> actor.id == record.property.user_id end))
    end
